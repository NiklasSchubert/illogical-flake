...
in {
  ...
  config = mkIf cfg.enable {
    ...
    xdg.configFile = {
      ...
      # Managed placeholder to prevent Hyprland from regenerating an autogenerated stub.
      # The actual config is hyprland.lua above; this file is inert.
      "hypr/hyprland.conf".text = ''
        # Managed by illogical-flake. Hyprland uses hyprland.lua as the active config.
        # This file exists only to prevent Hyprland from generating an autogenerated stub.
      '';
      ...
      # Hyprland Custom Env - inject Nix-specific environment fixes and declarative
      # plugin loading ahead of the user's custom env.lua.
      "hypr/custom/env.lua".text = ''
        -- Injected by illogical-flake for Nix-managed Hyprland.
      ...
      '' + builtins.readFile "${dotfilesSource}/dots/.config/hypr/custom/env.lua";
    ...
    home.activation.copyIllogicalImpulseConfigs = config.lib.dag.entryAfter ["writeBoundary"] ''
      ...
      seed_matugen_file "$targetPath/hypr/hyprland/colors.lua"     "$configPath/hypr/hyprland/colors.lua"
